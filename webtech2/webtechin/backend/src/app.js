...
var url = 'mongodb://localhost:27017/itemDataBase';
var databaseName = 'itemDataBase';
...
exports.app.post('/items', function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item = new Item_1.Item(req.body);
                    errors = [];
                    errors.push.apply(errors, validators_1.Validator.itemsPostError(item));
                    console.log(errors);
                    if (errors.length > 0) {
                        console.log(errors);
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, ItemService_1.addItem(item)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, ItemService_1.listItems()];
                case 2:
                    items = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                ...
                case 4: return [2 /*return*/, res.status(200).send(items)];
            }
        });
    });
});
exports.app.put('/items', function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var item, errors, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, ItemService_1.updateItem(item)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, ItemService_1.deleteItem(itemId)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
